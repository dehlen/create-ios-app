...
1. Update the README.md with details of changes to the interface, this includes new aspects of the project
	 generation, new command line interfaces or other relevant design changes.
2. Increase the version number to the new version that this
