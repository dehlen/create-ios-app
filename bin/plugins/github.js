...
var GithubPlugin = /** @class */ (function(_super) {
  __extends(GithubPlugin, _super);
  function GithubPlugin() {
    return _super.call(this) || this;
  }
  GithubPlugin.prototype.initRepository = function(workingDir, remoteUrl) {
  ...
  GithubPlugin.prototype.questions = function() {
    return [
      {
        type: "text",
        name: "githubURL",
  ...
  GithubPlugin.prototype.execute = function(configuration, destination) {
  ...
  GithubPlugin.prototype.postExecute = function(configuration, destination) {
    return __awaiter(this, void 0, void 0, function() {
      ...
      return __generator(this, function(_a) {
        switch (_a.label) {
          case 0:
            ...
            gitPushCommand = isEmpty(configuration.githubURL) ? "" : "push_to_git_remote";
