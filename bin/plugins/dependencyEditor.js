...
var DependencyEditorPlugin = /** @class */ (function (_super) {
    __extends(DependencyEditorPlugin, _super);
    function DependencyEditorPlugin() {
        return _super.call(this) || this;
    }
    DependencyEditorPlugin.prototype.questions = function () {
        return [
            {
                type: 'toggle',
    ...
    DependencyEditorPlugin.prototype.execute = function (configuration, destination) {
        return __awaiter(this, void 0, void 0, function () {
            var files, editor, child;
    ...
    DependencyEditorPlugin.prototype.postExecute = function (configuration, destination) {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    return DependencyEditorPlugin;
}(plugin_1.default));
exports.default = DependencyEditorPlugin;
