...
var GitHandlerPlugin = /** @class */ (function (_super) {
    __extends(GitHandlerPlugin, _super);
    function GitHandlerPlugin() {
        return _super.call(this) || this;
    }
    GitHandlerPlugin.prototype.initRepository = function (workingDir, remoteUrl) {
    ...
    GitHandlerPlugin.prototype.questions = function () {
        return [
            {
                type: 'text',
                name: 'repositoryURL',
    ...
    GitHandlerPlugin.prototype.execute = function (configuration, destination) {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    GitHandlerPlugin.prototype.postExecute = function (configuration, destination) {
        return __awaiter(this, void 0, void 0, function () {
            var gitPushCommand, stringUtil;
    ...
    return GitHandlerPlugin;
}(plugin_1.default));
exports.default = GitHandlerPlugin;
