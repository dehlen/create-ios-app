...
var NamePlugin = /** @class */ (function (_super) {
    ...
    NamePlugin.prototype.questions = function () {
        return [
            {
                type: 'text',
                name: 'bundleIdPrefix',
    ...
    NamePlugin.prototype.execute = function (configuration, destination) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, replace('{BUNDLE_IDENTIFIER_PREFIX}', stringUtil.removeTrailingDot(configuration.bundleIdPrefix), stringUtil.removeTrailingSlash(destination))];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
