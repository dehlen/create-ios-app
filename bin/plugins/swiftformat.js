...
var SwiftFormatPlugin = /** @class */ (function (_super) {
    ...
    SwiftFormatPlugin.prototype.execute = function (configuration, destination) {
        return __awaiter(this, void 0, void 0, function () {
            var swiftformatScriptPath;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!configuration.swiftformat) return [3 /*break*/, 2];
                        swiftformatScriptPath = path_1.join(this.pluginDirectory, 'scripts', 'swiftformat.sh');
                        return [4 /*yield*/, copy(swiftformatScriptPath, path_1.join(destination, 'scripts', 'swiftformat.sh'), {
                                overwrite: true,
                                expand: true,
                                dot: true,
                                junk: true
    ...
    SwiftFormatPlugin.prototype.postExecute = function (configuration, destination) {
        return __awaiter(this, void 0, void 0, function () {
            var stringUtil;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
exports.default = SwiftFormatPlugin;
